...
** Last Update:		$Author: smm $, $Date: 2002-10-01 19:41:07 $
** Source File:		$RCSfile: dcm_dump_file.c,v $
** Revision:		$Revision: 1.26 $
** Status:		$State: Exp $
*/

static char rcsid[] = "$Revision: 1.26 $ $RCSfile: dcm_dump_file.c,v $";
...
main(int argc, char **argv)
{
    DCM_OBJECT		* object;
    CONDITION		cond;
    CTNBOOLEAN		verbose = FALSE, exitFlag = FALSE, formatFlag = FALSE;
    ...
    while (--argc > 0 && (*++argv)[0] == '-') {
    	switch (*(argv[0] + 1)) {
			...
			case 'w':
							...
							if (strcmp(*argv, "REPEAT") == 0) options |= DCM_ALLOWREPEATELEMENTS;
							break;
			case 'z':
...
\n\
    -E        Efilm  + Part 10 file format\n\
    -L        Explicit LittleEndian\n\
    -B        Explicit BigEndian\n\
