...
static VECTOR messageVector[] = {
    ...
    {DUL_MALLOCERROR, "Routine %s failed to malloc %d bytes"},
    ...
    {DUL_PEERABORTEDASSOCIATION, "Peer aborted Association (or never connected)"},
    ...
    {DUL_ILLEGALREJECTREASON, "DUL Illegal reason for rejecting Association: %x"},
    {DUL_ILLEGALREJECTRESULT, "DUL Illegal result for rejecting Association: %x"},
    ...
    {DUL_FSMERROR, "DUL Finite State Machine Error, State: %d Event %d"},
    {DUL_PEERREQUESTEDRELEASE, "DUL Peer Requested Release"},
    {DUL_WRONGDATATYPE, "DUL Wrong Data Type Specified for Request"},
    {DUL_INSUFFICIENTBUFFERLENGTH, "DUL Insufficient buffer space allocated for data"},
    ...
    {DUL_PEERILLEGALXFERSYNTAXCOUNT, "DUL Peer supplied illegal number of transfer syntaxes (%d)"},
    {DUL_PCTRANSLATIONFAILURE, "DUL Presentation Context translation failure in %s"},
    ...
    {DUL_SNPNOTALLASSOC, "DUL SNP Error %s with %d associations to snoop on in %s"},
    {DUL_SNPBADSTATE, "DUL SNP facility in bad state %s in function %s"},
    {DUL_SNPBADASSOCSTATE, "DUL snooper transition into bad DUL association state"},
    {DUL_SNPUNIMPLEMENTED, "DUL snoop function %s unimplemented"},
