...
**			standard.
** Last Update:		$Author: smm $, $Date: 1999/09/24 02:53:14 $
...
#define	FORM_COND(facility, severity, value) (CONDITION)((((unsigned long)value)<<16) | (((unsigned long)facility) << 4) | ((unsigned long)severity))
...
#define	FAC_DMAN	23	/* DICOM Management of application connections */
